...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    Route::prefix('external-accounts')->middleware('verified')->group(function () {
        ...
        Route::prefix('google')->group(function () {
            Route::get('/zaloguj', 'Auth\GoogleAuthController@redirectToProvider')->name('google.signin');
            Route::get('/wyloguj', 'Auth\GoogleAuthController@signout')->name('google.signout');
        });
    });
});
